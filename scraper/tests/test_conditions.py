...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("This bonus is not available to previous account holders", "new_customer", None, None, None),
        (
...
def test_extract_conditions_dedupes_by_id_and_preserves_order():
    text = (
        ...
        "This bonus is not available to previous account holders who already received one. "
        "Offer is for new consumer checking customers only and is limited to one account per household."
    )
...
def test_extract_conditions_sets_source():
    text = "This bonus is not available to previous account holders who already received one before."
